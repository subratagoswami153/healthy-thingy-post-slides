...
<!--             <tr class="ads-unit-for-action-trigger" >
                ...
                <td>
                    <input class="single_field" type="text" value="<?php //echo (isset($each_data['ads_unit_for_action_trigger'])) ? $each_data['ads_unit_for_action_trigger'] : '2'; ?>" name="data[0][ads_unit_for_action_trigger][]" placeholder="Ads unit for action trigger"/>
                </td>
            </tr> -->
            <tr>
                <th ></th>
