    ...
    <div class="content">
        <table>
            ...
            <tr class="fixed-content-ajax" style="display:<?php echo ((isset($each_data['layout']) && ($each_data['layout'] == 'long-form-fixed'))) ? 'table-row' : ''; ?>">
                ...
                <td>
                    <select class="single_field ajax_match_by" name="data[0][fixed_content_ajax][]">
            ...
            <tr class="qty_field_ajax field-hide" style="display:<?php echo ((isset($each_data['layout']) && ($each_data['layout'] != 'slides' && $each_data['layout'] != 'none' && $each_data['fixed_content_ajax'] != 'no'))) ? 'table-row' : ''; ?>">
            ...
            <tr class="periodical-content" style="display:<?php echo ((isset($each_data['layout']) && ($each_data['layout'] == 'long-form-fixed'))) ? 'table-row' : ''; ?>">
                ...
                <td>
                    <input type="checkbox" class="periodical-yes" name="data[0][periodical_yes][]" value="yes" <?php echo ($each_data['periodical_yes']=='yes')?'checked':''; ?> >
                    <input type="hidden" class="periodical-yes-hidden"  name="data[0][periodical_yes_hidden][]" value="<?php echo ($each_data['periodical_yes']=='yes')?'yes':''; ?>"  >
            ...
            <tr class="periodical-qty" style="display:<?php echo ($each_data['layout'] == 'long-form-fixed' && ($each_data['periodical_yes'] == 'yes')) ? 'table-row' : ''; ?>">
                ...
                <td>
                    <input class="single_field" type="text" value="<?php echo (isset($each_data['periodical_interval'])) ? $each_data['periodical_interval'] : '2'; ?>" name="data[0][periodical_interval][]" placeholder="Periodical Interval Times"/>
                </td>
            </tr>
            
            
            
            <tr class="left-ads-layout" style="display:<?php echo ($mobile)?'none':''; ?>">
            ...
            <tr class="right-ads-layout" style="display:<?php echo ($mobile)?'none':''; ?>">
             ...
             <tr class="ads-unit-for-action-trigger" display:<?php echo ($mobile)?'none':''; ?> >
