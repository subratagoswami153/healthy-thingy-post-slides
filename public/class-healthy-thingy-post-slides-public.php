...
class Healthy_Thingy_Post_Slides_Public {
    ...
    public function enqueue_scripts() {
        ...
        if (Healthy_Thingy_Post_Slides_Admin::$desktop_fixed_content_ajax == 'yes' && Healthy_Thingy_Post_Slides_Admin::$post_style == 'long-form-fixed') {
        ...
        if (Healthy_Thingy_Post_Slides_Admin::$mobile_fixed_content_ajax == 'yes' && Healthy_Thingy_Post_Slides_Admin::$post_style_mobile == 'long-form-fixed') {
        ...
        wp_localize_script($this->plugin_name . 'public-js', 'healthyThingyObj', array(
            ...
            'periodical_yes' => Healthy_Thingy_Post_Slides_Admin::$periodical_yes,
            'periodical_interval' => Healthy_Thingy_Post_Slides_Admin::$periodical_interval,
    ...
    public function select_one($request) {
        ...
        if (is_string($arguments)) {
            ...
            https://healthythingy.com/how-to-make-your-hands-look-youthful-again/#google_vignette
        }
        ...
        if (isset($methods[$method]) && isset($id)) {
            ...
            return apply_filters(
                    'advanced-ads-cache-busting-item', $r, array(
                'id' => $id,
                'method' => $method,
                'args' => $arguments,
                    )
    ...
    public function css_action_triggered() {
        if (!(wp_is_mobile())) {
            if (Healthy_Thingy_Post_Slides_Admin::$left_ads_layout == 'action-triggered-ads' && Healthy_Thingy_Post_Slides_Admin::$right_ads_layout == 'action-triggered-ads') {
                ...
                <?php } elseif (Healthy_Thingy_Post_Slides_Admin::$left_ads_layout == 'action-triggered-ads' && Healthy_Thingy_Post_Slides_Admin::$right_ads_layout == 'default-ads') {
                ?>
                <style type="text/css">
                    .ads-padding-top-120{
                        margin-top: <?php echo (get_option('action_triggered_top_margin') != '') ? get_option('action_triggered_top_margin') : '150px'; ?>;
